...
public class MutableSetDemo {
	...
	public static void main(String[] args) {
		 ...
		 * issues caused by using a mutable object in a set. However, what happens if we
		 * mutate (i.e change or modify) one of the objects?
		 */
		 ...
		 * normal set! This is caused by the mutation/change made to one of the objects.
		 * The other objects will behave as normal:
		 */
		...
		/*
		 * Just be careful if you ever decide to use a mutable object in a set, or as a
		 * key in a map. These collections aren't designed to handle mutable objects and
