...
public class WidgetDemo {
	...
	public static void main(String[] args) {
		 ...
		 * instances created. That is why static members are initialized at declaration!
		 */
		 ...
		 * class. They have their own instance attributes, but share class attributes.
		 *
		 * DECLARATION - We have declared the identifiers for these elements, but memory
		 * has not yet been reserved. Any access will result in a null pointer
		 * exception.
		 */
		Widget widget1;
		Widget widget2;
		...
		/*
		 * DEFINITION - We are reserving memory with the "new" keyword, creating actual
