...
public class GenericTypesDemo {
	...
	public static void rawDemo() {
		...
		/*
		 * And, when we access the elements in our list, the reference will always be an
		 * Object. We have to downcast to access the actual String type, and this could
	...
	public static void listDemo() {
		/*
		 * Instead of raw types, use the Generic types notation to specify what type of
		 ...
		 * re-specifying the type in the < > angle brackets if Java can infer the type.
		 */
	 ...
	 * that method more generalized. If we use upcasting and return an Object type,
	 * it has to be downcast later on back to its original type. This way, we always
	 * return the object in its own type without forcing casting (upcasting or
	 * downcasting) later on.
	 *
...
//		}
	...
	/**
	 * This method demonstrates how we can replace restrictions on the Generic type
	 * if necessary.
	 *
	...
	/**
	 * This method demonstrates how we can create generalized classes using Generic
	 * types as well, allowing the developer to specify the type of object or
	 * objects that should be used by that class.
	 *
	 * @see Pair
	 */
	...
	/**
	 * This method demonstrates how to use wildcards to bound the generic type to a
	 * {@link Number}, and use upcasting.
	 *
