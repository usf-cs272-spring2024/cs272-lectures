package edu.usfca.cs272.lectures.inheritance.shape;
...
public class Rectangle extends Shape {
	...
	/*
	 * A default constructor still makes sense here. This constructor will call the
	 * other constructor above, which calls the constructor for Shape. This is an
	 * example of chaining constructor calls.
	 */
	...
	/*
	 * If you want to be able to create a Rectangle object (i.e. you do not want to
	 * make this class abstract), you MUST implement all of the abstract methods
	 * inherited at this point.
	 */
	...
	/*
	 * You can also provide new methods not found in Shape. These will be inherited
	 * by any subclasses of Rectangle.
	 */
