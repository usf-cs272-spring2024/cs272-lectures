 ...
 *
 * @see IndexedSet
 * @see SynchronizedIndexedSet
 * @see ConcurrentIndexedSet
 *
...
public class IndexedSetDemo {
	 ...
	 *
	 * @see IndexedSetDemo#expensiveReads(IndexedSet, boolean)
	 */
	...
	public static double benchmark(int size) throws InterruptedException {
		...
		IndexedSet<Integer> set3 = new ConcurrentIndexedSet<>();
		...
		/*
		 * calculate and output minimum and average times
		 */
		...
		/*
		 * calculate and output speedups (using minimums)
		 */
